...
/**
 * trik_biag - Display enviroment variable
 * @amrot: parsed amrhjkx
 * @st: status of last amrhjkx executed
 * Return: Always 0
 */
int trik_biag(__attribute__((unused)) char **amrot, __attribute__((unused)) int st)
{
	size_t i;
	int len;
...
/**
 * trikharf - display history of user dkhkhar on simple_shell
 * @c: parsed amrhjkx
 * @st: status of last amrhjkx executed
 * Return: 0 success or -1 if fail
 */
int trikharf(__attribute__((unused))char **c, __attribute__((unused))int st)
{
