...
char *_strncpy(char *trik, char *msdr, int n);
int _strlen(char *s);
int _putchar(char c);
int _atoi(char *s);
...
char *_memcpy(char *trik, char *msdr, unsigned int n);
...
int trik_biag(__attribute__((unused)) char **amrot,
	    __attribute__((unused)) int st);
int shrmytpz(char **amrot, int st);
int trikharf(__attribute__((unused))char **c,
		__attribute__((unused)) int st);
